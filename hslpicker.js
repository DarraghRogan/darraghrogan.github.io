...
(function() {
    ...
    var S = k.each = k.forEach = function(t, e, i) {
        if (null != t)
            if (c && t.forEach === c)
                ...
                for (var o in t)
                    if (k.has(t, o) && e.call(i, t[o], o, t) === n)
                        return
    }
    ;
    ...
    k.uniq = k.unique = function(t, e, n, i) {
        ...
        return S(r, function(n, i) {
            (e ? i && o[o.length - 1] === n : k.contains(o, n)) || (o.push(n),
            s.push(t[i]))
        }),
        s
    }
    ...
    ,
    k.zip = function() {
        for (var t = a.call(arguments), e = k.max(k.pluck(t, "length")), n = new Array(e), i = 0; e > i; i++)
            n[i] = k.pluck(t, "" + i);
        return n
    }
    ,
    ...
    k.bindAll = function(t) {
        var e = a.call(arguments, 1);
        return 0 == e.length && (e = k.functions(t)),
        S(e, function(e) {
            t[e] = k.bind(t[e], t)
        }),
        t
...
function() {
    ...
    var u = /\s+/
      , h = function(t, e, n, i) {
        ...
        if ("object" == typeof n)
            ...
            if (!u.test(n))
                return !0;
            for (var s = n.split(u), o = 0, a = s.length; a > o; o++)
      ...
      , c = t.Events = {
        ...
        listenTo: function(t, e, n) {
            ...
            return i[r] = t,
            t.on(e, "object" == typeof e ? this : n, this),
            this
        },
    ...
    a.extend(f.prototype, c, {
        ...
        set: function(t, e, n) {
            ...
            for (i in r)
                e = r[i],
                a.isEqual(c[i], e) || o.push(i),
                a.isEqual(l[i], e) ? delete this.changed[i] : this.changed[i] = e,
                s ? delete c[i] : c[i] = e;
            if (!u) {
                o.length && (this._pending = !0);
                for (var f = 0, d = o.length; d > f; f++)
                    this.trigger("change:" + o[f], this, c[o[f]], n)
            }
            if (h)
                return this;
            if (!u)
        ...
        save: function(t, e, n) {
            ...
            this._validate(i, n) ? (i && n.wait && (this.attributes = a.extend({}, u, i)),
            void 0 === n.parse && (n.parse = !0),
            r = n.success,
            n.success = function(t, e, n) {
                t.attributes = u;
                var s = t.parse(e, n);
                return n.wait && (s = a.extend(i || {}, s)),
                a.isObject(s) && !t.set(s, n) ? !1 : void (r && r(t, e, n))
            }
            ,
        ...
        _validate: function(t, e) {
            ...
            return n ? (this.trigger("invalid", this, n, e || {}),
            !1) : !0
        }
    });
    ...
    a.extend(d.prototype, c, {
        ...
        add: function(t, e) {
            ...
            for (c = [],
            f = e.at,
            d = this.comparator && null == f && 0 != e.sort,
            p = a.isString(this.comparator) ? this.comparator : null,
            n = 0,
            i = t.length; i > n; n++)
                (s = this._prepareModel(u = t[n], e)) ? (h = this.get(s)) ? e.merge && (h.set(u === s ? s.attributes : u, e),
                d && !l && h.hasChanged(p) && (l = !0)) : (c.push(s),
                s.on("all", this._onModelEvent, this),
                this._byId[s.cid] = s,
                null != s.id && (this._byId[s.id] = s)) : this.trigger("invalid", this, u, e);
            if (c.length && (d && (l = !0),
            this.length += c.length,
            null != f ? o.apply(this.models, [f, 0].concat(c)) : r.apply(this.models, c)),
            l && this.sort({
                silent: !0
            }),
            e.silent)
            ...
            for (n = 0,
            i = c.length; i > n; n++)
                (s = c[n]).trigger("add", s, this, e);
            return l && this.trigger("sort", this, e),
            this
        },
        remove: function(t, e) {
            t = a.isArray(t) ? t.slice() : [t],
        ...
        get: function(t) {
            return null == t ? void 0 : (this._idAttr || (this._idAttr = this.model.prototype.idAttribute),
        ...
        update: function(t, e) {
            ...
            r = t.length; r > i; i++)
                ...
                (e.add && !s || e.merge && s) && o.push(n);
            if (e.remove)
                for (i = 0,
                r = this.models.length; r > i; i++)
                    n = this.models[i],
                    h[n.cid] || u.push(n);
            return u.length && this.remove(u, e),
    ...
    a.extend(v.prototype, c, {
        ...
        route: function(e, n, i) {
            return a.isRegExp(e) || (e = this._routeToRegExp(e)),
            i || (i = this[n]),
            t.history.route(e, a.bind(function(r) {
                var s = this._extractParameters(e, r);
                i && i.apply(this, s),
                this.trigger.apply(this, ["route:" + n].concat(s)),
                this.trigger("route", n, s),
                t.history.trigger("route", this, n, s)
            }, this)),
            this
        },
    ...
    a.extend(w.prototype, c, {
        ...
        start: function(e) {
            ...
            r && this._wantsHashChange && (this.iframe = t.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow,
            this.navigate(n)),
            ...
            !0) : (this._wantsPushState && this._hasPushState && o && s.hash && (this.fragment = this.getHash().replace(_, ""),
    ...
    t.sync = function(e, n, i) {
        ...
        if (i.url || (s.url = a.result(n, "url") || $()),
        null != i.data || !n || "create" !== e && "update" !== e && "patch" !== e || (s.contentType = "application/json",
...
var Cursor = {
    ...
    refresh: function(t) {
        t || (t = window.event),
        "mousemove" == t.type ? this.set(t) : t.touches && this.set(t.touches[0])
    },
    set: function(t) {
        t.pageX || t.pageY ? (this.x = t.pageX,
        this.y = t.pageY) : (t.clientX || t.clientY) && (this.x = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft,
        this.y = t.clientY + document.body.scrollTop + document.documentElement.scrollTop)
    }
};
Cursor.init();
var Position = {
    get: function(t) {
        ...
        if (t.offsetParent)
            do
                e += t.offsetLeft,
                curtop += t.offsetTop;
            while (t = t.offsetParent);return [e, curtop]
    }
}
  , Dragdealer = function(t, e) {
    ...
    t) {
        ...
        n && -1 != n.className.search(/(^|\s)handle(\s|$)/) && (this.init(t, n, e || {}),
        this.setup())
    }
};
Dragdealer.prototype = {
    init: function(t, e, n) {
        ...
        this.callback = n.callback || null,
        this.animationCallback = n.animationCallback || null,
        this.bounds = {
            left: n.left || 0,
            right: -(n.right || 0),
            top: n.top || 0,
    ...
    setBoundsPadding: function() {
        this.bounds.left || this.bounds.right || (this.bounds.left = Position.get(this.handle)[0] - this.offset.wrapper[0],
        this.bounds.right = -this.bounds.left),
        this.bounds.top || this.bounds.bottom || (this.bounds.top = Position.get(this.handle)[1] - this.offset.wrapper[1],
    ...
    setSteps: function() {
        if (this.steps > 1) {
            this.stepRatios = [];
            for (var t = 0; t <= this.steps - 1; t++)
                this.stepRatios[t] = t / (this.steps - 1)
        }
    },
    ...
    setValue: function(t, e, n) {
        this.setTargetValue([t, e || 0]),
        n && this.groupCopy(this.value.current, this.value.target)
    },
    startTap: function(t) {
        this.disabled || (this.tapping = !0,
        void 0 === t && (t = [Cursor.x - this.offset.wrapper[0] - this.handle.offsetWidth / 2, Cursor.y - this.offset.wrapper[1] - this.handle.offsetHeight / 2]),
        this.setTargetOffset(t))
    },
    stopTap: function() {
    ...
    startDrag: function() {
        this.disabled || (this.offset.mouse = [Cursor.x - Position.get(this.handle)[0], Cursor.y - Position.get(this.handle)[1]],
        this.dragging = !0)
    },
    stopDrag: function() {
    ...
    feedback: function() {
        ...
        this.snap && this.steps > 1 && (t = this.getClosestSteps(t)),
        this.groupCompare(t, this.value.prev) || ("function" == typeof this.animationCallback && this.animationCallback(t[0], t[1]),
    ...
    animate: function(t, e) {
        if (!t || this.dragging) {
            if (this.dragging) {
                ...
                this.setTargetOffset(i, this.loose),
                this.change = [this.value.target[0] - n[0], this.value.target[1] - n[1]]
            }
            (this.dragging || e) && this.groupCopy(this.value.current, this.value.target),
            (this.dragging || this.glide() || e) && (this.update(),
            this.feedback())
        }
    },
    glide: function() {
        var t = [this.value.target[0] - this.value.current[0], this.value.target[1] - this.value.current[1]];
        return t[0] || t[1] ? (Math.abs(t[0]) > this.bounds.xStep || Math.abs(t[1]) > this.bounds.yStep ? (this.value.current[0] += t[0] * this.speed,
        this.value.current[1] += t[1] * this.speed) : this.groupCopy(this.value.current, this.value.target),
        !0) : !1
    },
    update: function() {
        this.offset.current = this.getOffsetsByRatios(this.snap ? this.getClosestSteps(this.value.current) : this.value.current),
        this.show()
    },
    show: function() {
        this.groupCompare(this.offset.current, this.offset.prev) || (this.horizontal && (this.handle.style.left = String(this.offset.current[0]) + "px"),
        this.vertical && (this.handle.style.top = String(this.offset.current[1]) + "px"),
    ...
    getProperValue: function(t) {
        ...
        return e[0] = Math.max(e[0], 0),
        e[1] = Math.max(e[1], 0),
        e[0] = Math.min(e[0], 1),
        e[1] = Math.min(e[1], 1),
        (!this.dragging && !this.tapping || this.snap) && this.steps > 1 && (e = this.getClosestSteps(e)),
        e
    },
    ...
    getClosestStep: function(t) {
        for (var e = 0, n = 1, i = 0; i <= this.steps - 1; i++)
            Math.abs(this.stepRatios[i] - t) < n && (n = Math.abs(this.stepRatios[i] - t),
            e = i);
    ...
    preventDefaults: function(t, e) {
        ...
        t.returnValue = !1,
        e && document.selection && document.selection.empty()
    },
...
function() {
    if (!this.require) {
        ...
        ,
        this.require.modules = t,
        this.require.cache = e
    }
...
.call(this)({
        ...
        (function() {
            ...
            t = Backbone.Model.extend({
                ...
                updateRgb: function(t) {
                    return t || (t = this.hslToRgb(this.hsla())),
                    this.set({
                        rgb: [t[0], t[1], t[2]]
                    }),
                    t
                ...
                hsla: function(t) {
                    return null != t ? (t = this.isHsl(t),
                    t ? (this.hsla().join(",") !== t.join(",") && (this.updateHex(this.updateRgb(this.hslToRgb(t))),
                    this.updateHsl(t),
                    this.set({
                        a: null != t[3] ? t[3] : 1
                    })),
                ...
                hslaStr: function(t) {
                    return t || (t = this.hsla()),
                    "hsla(" + t[0] + ", " + t[1] + "%, " + t[2] + "%, " + t[3] + ")"
                },
                rgba: function(t) {
                    return null != t ? (t = this.isRgb(t),
                    t ? (t.join(",") !== this.rgba().join(",") && (this.set({
                        rgb: [t[0], t[1], t[2]],
                        a: null != t[3] ? t[3] : 1
                    }),
                    this.updateHex(t),
                    this.updateHsl(this.rgbToHsl(t))),
                    t) : !1) : this.get("rgb").concat(this.get("a"))
                },
                rgbaStr: function() {
                    var t;
                    return t = this.get("rgb"),
                    "rgba(" + t[0] + ", " + t[1] + ", " + t[2] + ", " + this.get("a") + ")"
                },
                hex: function(t) {
                    var e;
                    return null != t ? (t = this.isHex(t),
                    t ? (this.hex() !== t && (this.set({
                        hex: t
                    }),
                    e = this.hexToRgb(t),
                    this.updateRgb(e),
                    ...
                    this.updateHsl(this.rgbToHsl(e))),
                    t) : !1) : this.get("hex")
                },
                isHex: function(e, n) {
                    var i, r;
                    return null == n && (n = !0),
                    i = null != (r = e.match(/^#?([0-9a-fA-F]{3})([0-9a-fA-F]{3})?$/)) ? r.slice(1) : void 0,
                    null == i ? !1 : (t = _.compact(i).join(""),
                    n ? "#" + t : t)
                },
                isRgb: function(t) {
                    var e, n, i, r;
                    if ("string" == typeof t) {
                        if (n = null != (r = t.match(/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,?\s*(0?\.?\d+)?\s*\)$/)) ? r.slice(1) : void 0,
                        null == n)
                            return !1;
                        t = function() {
                            var t, i, r, s;
                    ...
                    return null == t[3] && (t[3] = 1),
                    i = t[0] <= 255 && t[1] <= 255 && t[2] <= 255 && t[3] <= 1,
                    i ? t : !1
                },
                isHsl: function(t) {
                    var e, n, i, r;
                    if ("string" == typeof t) {
                        if (n = null != (r = t.match(/hsla?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\%\s*,\s*(\d{1,3})\%\s*,?\s*(0?\.?\d+)?\s*\)$/)) ? r.slice(1) : void 0,
                        null == n)
                            return !1;
                        t = function() {
                            var t, i, r, s;
                    ...
                    return null == t[3] && (t[3] = 1),
                    i = t[0] <= 360 && t[1] <= 100 && t[2] <= 100 && t[3] <= 1,
                    i ? t : !1
                },
                valid: function(t) {
                    var e;
                    return e = this.type(t),
                    "hex" === e ? this.isHex(t) : "rgb" === e ? this.isRgb(t) : "hsl" === e ? this.isHsl(t) : !1
                },
                ...
                type: function(t) {
                    var e, n;
                    return e = t.toString(),
                    n = e.indexOf("#") >= 0 || 3 === e.length || 6 === e.length ? "hex" : e.indexOf("%") ? "hsl" : "rgb"
                },
                hexToRgb: function(e) {
                    var n;
                    ...
                    t = function() {
                        ...
                        i = t.length; i > e; e++)
                            n = t[e],
                            r.push(parseInt(n, 16));
                        return r
                    }().concat([1])) : !1
                },
                hexToHsl: function(t) {
                    return (t.indexOf("#") >= 0 || t.length < 6) && (t = this.isHex(t)),
                    t ? this.rgbToHsl(this.hexToRgb(t)) : !1
                },
                rgbToHex: function(t) {
                    var e, n, i;
                    return "string" == typeof t && (t = this.isRgb(t)),
                    t ? (n = function() {
                        var n, i, r, s;
                        for (r = t.slice(0, 3),
                        s = [],
                        ...
                        i = r.length; i > n; n++)
                            e = r[n],
                            s.push(parseFloat(e).toString(16));
                        return s
                    }(),
                    n = function() {
                        var t, i, r;
                        ...
                        i = n.length; i > t; t++)
                            e = n[t],
                            r.push(1 === e.length ? "0" + e : e);
                        return r
                    }(),
                    n = n.join(""),
                    3 === _.compact(function() {
                        var t, e, r, s;
                        for (r = n.match(/.{1,2}/g),
                        s = [],
                        t = 0,
                ...
                rgbToHsl: function(t) {
                    ...
                    return "string" == typeof t && (t = this.isRgb(t)),
                    t ? (f = parseFloat(t[0]) / 255,
                    s = parseFloat(t[1]) / 255,
                    i = parseFloat(t[2]) / 255,
                    l = Math.max(f, s, i),
                    c = Math.min(f, s, i),
                    r = l - c,
                    n = l + c,
                    a = c === l ? 0 : f === l ? (60 * (s - i) / r + 360) % 360 : s === l ? 60 * (i - f) / r + 120 : 60 * (f - s) / r + 240,
                    h = .5 * n,
                    p = 0 === h ? 0 : 1 === h ? 1 : .5 >= h ? r / n : r / (2 - n),
                    o = Math.round(a),
                    d = Math.round(100 * p),
                    u = Math.round(100 * h),
                    e = parseFloat(t[3]) || 1,
                ...
                hslToRgb: function(t) {
                    ...
                    return "string" == typeof t && (t = this.isHsl(t)),
                    t ? (o = parseInt(t[0]) / 360,
                    f = parseInt(t[1]) / 100,
                    a = parseInt(t[2]) / 100,
                    h = .5 >= a ? a * (1 + f) : a + f - a * f,
                    u = 2 * a - h,
                    ...
                    s = o,
                    i = o - 1 / 3,
                    l = Math.round(255 * this.hueToRgb(u, h, c)),
                    r = Math.round(255 * this.hueToRgb(u, h, s)),
                    n = Math.round(255 * this.hueToRgb(u, h, i)),
                    e = parseFloat(t[3]) || 1,
                    [l, r, n, e]) : !1
                },
                hslToHex: function(t) {
                    return "string" == typeof t && (t = this.isHsl(t)),
                    t ? this.rgbToHex(this.hslToRgb(t)) : !1
                },
        ...
        (function() {
            ...
            t = Backbone.View.extend({
                initialize: function(t) {
                    ...
                    this.model.on("change:rgb", this.changeRgb, this)
                },
                events: {
                ...
                changeColor: function(t) {
                    var e;
                    return e = $(t.target),
                    this.model[e.attr("id")](e.val()) ? e.removeClass("error") : e.addClass("error")
                },
                bumpHsl: function(t) {
                    var e, n;
                    return 38 === t.keyCode || 40 === t.keyCode ? (e = $(t.target).attr("id"),
                    n = t.shiftKey ? 10 : 1,
                    40 === t.keyCode && (n = -n),
                    this.bumpValue(e, n),
                ...
                bumpValue: function(t, e) {
                    var n, i;
                    switch (n = this.model.get(t),
                    i = "a" === t ? Math.round(100 * n + e) / 100 : n + e,
                    t) {
                    case "h":
                        i = this.gate(i, 360);
                        break;
                ...
                editHsl: function(t) {
                    ...
                    n = e.attr("id"),
                    i = parseFloat(e.val()),
                    this.model.inRange(n, i) ? (e.removeClass("error"),
                    this.model[n](i)) : e.addClass("error")
                },
                changeHex: function() {
                ...
                setHue: function() {
                    return this.update($("#h"), this.model.get("h")),
                    this.changeHsl()
                },
                setSat: function() {
                    return this.update($("#s"), this.model.get("s")),
                    this.changeHsl()
                },
                setLum: function() {
                    return this.update($("#l"), this.model.get("l")),
                    this.changeHsl()
                },
                setAlpha: function() {
                    return this.update($("#a"), this.model.get("a")),
                    this.changeHsl()
                },
                update: function(t, e) {
        ...
        (function() {
            ...
            t = Backbone.View.extend({
                ...
                render: function() {
                    return this.hueSlider = this.$("#h-slider").dragdealer({
                        ...
                        animationCallback: function(t) {
                            return function(e) {
                                var n;
                                return n = Math.round(360 * e),
                                t.model.get("h") !== n ? t.model.h(n) : void 0
                            }
                        }(this)
                    }),
                    this.satSlider = this.$("#s-slider").dragdealer({
                        ...
                        animationCallback: function(t) {
                            return function(e) {
                                var n;
                                return n = Math.round(100 * e),
                                t.model.get("s") !== n ? t.model.s(n) : void 0
                            }
                        }(this)
                    }),
                    this.lumSlider = this.$("#l-slider").dragdealer({
                        ...
                        animationCallback: function(t) {
                            return function(e) {
                                var n;
                                return n = Math.round(100 * e),
                                t.model.get("l") !== n ? t.model.l(n) : void 0
                            }
                        }(this)
                    }),
                    this.alphaSlider = this.$("#a-slider").dragdealer({
                        ...
                        animationCallback: function(t) {
                            return function(e) {
                                var n;
                                return n = Math.round(100 * e) / 100,
                                t.model.get("a") !== n ? t.model.a(n) : void 0
                            }
                        }(this)
                    }),
                ...
                setHue: function() {
                    ...
                    this.updateSliderStyles("h")
                },
                setSat: function() {
                    return this.setSlider(this.satSlider, this.model.get("s"), 100),
                    this.updateSliderStyles("s")
                },
                setLum: function() {
                    return this.setSlider(this.lumSlider, this.model.get("l"), 100),
                    this.updateSliderStyles("l")
                },
                setAlpha: function() {
                    return this.setSlider(this.alphaSlider, 100 * this.model.get("a"), 100),
                    this.updateSliderStyles("a")
                },
                ...
                updateSliderStyles: function(t) {
                    var e, n, i, r, s;
                    for (n = _.without(["h", "s", "l", "a"], t),
                    s = [],
                    i = 0,
                    r = n.length; r > i; i++)
                        e = n[i],
                        s.push(this.setSliderBg(e));
                    return s
                },
                ...
                gradient: function(t) {
                    ...
                    return e = function() {
                        var e, s;
                        for (s = [],
                        i = e = 0; r >= 0 ? r >= e : e >= r; i = r >= 0 ? ++e : --e)
                            s.push(this.model.hslaStr(this.tweakHsla(t, i * n)));
                        return s
                    }
                    .call(this),
                    "linear-gradient(left, " + e.join(",") + ");"
                },
                tweakHsla: function(t, e) {
                    var n, i;
                    switch (n = this.model.hsla(),
                    t) {
                    case "h":
                        i = 0;
                        break;
        ...
        (function() {
            ...
            o = Backbone.View.extend({
                initialize: function(e) {
                    ...
                    t = this.urlToColor(window.location.hash) || this.model.randomColor(),
                    this.model.hsla(t)
                },
                events: {
                    "click .url": "selectUrl",
                ...
                updateColor: function() {
                    var e, n;
                    return t = this.model.hsla(),
                    n = this.model.get("tile"),
                    e = {},
                    e[n] = t,
                    this.model.set(e),
                    "foreground" === n ? this.setPageStyles() : void 0
                },
                selectUrl: function(t) {
                    return t.target.select()
                },
                toggleWhy: function() {
                    return $("#more").toggleClass("hide"),
                    e.preventDefault()
                },
                urlToColor: function(e) {
                    ...
                    return e.length ? (r = function() {
                        ...
                        r = s.length; r > i; i++)
                            ...
                            o = t[0],
                            n = t[1],
                            a = this.model.hexToRgb(o),
                            h.push(u = null != n ? (a.splice(-1, 1, parseFloat(n)),
                            this.model.rgbToHsl(a)) : this.model.rgbToHsl(a));
                        return h
                    }
                    .call(this),
                    s = r[0],
                    i = r[1],
                    null != s && this.model.set({
                        foreground: s
                    }),
                ...
                setUrl: function() {
                    var t, e, n, i, r, s;
                    return n = window.location.host,
                    e = this.getColorUrl(this.model.get("foreground")),
                    t = this.model.get("background"),
                    t[3] > 0 && (e += "/" + this.getColorUrl(t)),
                    r = n + "/" + e,
                    r !== window.location.host + "/" + window.location.hash ? (i = $(".url"),
                ...
                getColorUrl: function(t) {
                    var e;
                    return e = this.model.hslToHex(t),
                    1 !== t[3] && (e += "," + t[3]),
                    e
                },
                setPageStyles: function() {
                    var t, e, n, i;
                    return e = this.model.hsla(),
                    _.contains(e, void 0) ? void 0 : (n = this.model.hslaStr([e[0], 100, 70, 1]),
                    i = this.model.hslaStr([e[0], 40, 70, 1]),
                    t = this.model.hslaStr([e[0], 40, 70, 1]),
                    $("h1").css("text-shadow", this.getTextShadow(e)),
                    this.style.text("body a:hover { color: " + n + " !important } h1 + p { color: " + i + " } body h2, body h3, code { color: " + t + " }"))
                },
                getTextShadow: function(e) {
                    var n, i, r, s;
                    return r = e[2],
                    s = 35 > r ? 30 : r > 80 ? 30 : e[1],
                    i = 35 > r ? 35 : r > 80 ? 80 : r,
                    t = [e[0], Math.round(s / 2.7), i],
                    n = [],
                    _(4).times(function(e) {
                        return function(i) {
                ...
                adjustLum: function(t, e) {
                    return null == e && (e = this.model.hsla()),
                    this.model.hslaStr([e[0], e[1], e[2] + 1, this.model.get("a")])
                },
    ...
    tiles: function(t, e, n) {
        (function() {
            ...
            t = Backbone.View.extend({
                initialize: function() {
                    return this.model.on("change:foreground", this.updateForeground, this),
                    this.model.on("change:background", this.updateBackground, this),
                    this.model.get("background") || this.model.set({
                ...
                toggleExposed: function() {
                    return $(".color-tiles").toggleClass("exposed"),
                ...
                selectTile: function(t) {
                    ...
                    e.is(".selected") ? void 0 : (this.model.set({
                        tile: e.data("name")
                    }),
                    this.model.hsla(this.model.get(e.data("name"))),
                ...
                setTileBg: function(t) {
                    var e, n;
                    return n = $(t.target),
                    n.is(".random") ? (e = this.model.randomColor(),
                    e[3] = this.model.get("a") || 1,
                    this.model.hsla(e)) : this.model.hsla(n.data("color"))
                },
